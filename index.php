      ...
      <div class="container">
        ...
        <ul class="visual" id="todos">
          <!-- <li class="myCheck">
            ...
            <label for="check1">Examples :-</label>
          </li>
          <li class="myCheck">
            <input type="checkbox" id="check2">
            <label for="check2">Do your Homework</label>
          </li>
          <li class="myCheck">
            <input type="checkbox" id="check3">
            <label for="check3">Go To GYM</label>
          </li>
          <li class="myCheck">
            <input type="checkbox" id="check4">
            <label for="check4">Attend the meeting</label>
          </li>
          <li class="myCheck">
            <input type="checkbox" id="check5">
            <label for="check5">Assignment</label>
          </li> -->
        </ul>
